...
class AdminTagsController extends Controller
{
    ...
    public function index(Request $request)
    {
       ...
       // $data['tags'] = $this->tagsRepository->all();
        return view('private.admin.tags.list');
    }
    ...
    public function showTagsSuggestions(Request $request)
    {
        ...
        $return['results'] = TagsModel::where('name', 'like', "%{$inputs['search']}%")->get();
    ...
    {
        return view('private.admin.tags.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('private.admin.tags.edit',$data);
