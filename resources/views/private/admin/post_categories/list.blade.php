...
@section('content')
    ...
    <section>
        ...
        <div class="container-fluid text-right" style="margin-bottom: 16px;">
            <a class="btn btn-success" href="{{route('admin.categories.show')}}">
                Add New
            </a>
        </div>
        <table class="table">
            ...
            @foreach($list as $post_category)
                <tr>
                    ...
                    <td>
                        <a href="{{route('admin.categories.edit',['category'=>$post_category->id])}}" class="btn btn-primary">
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        {{Form::open(['url'=>route('admin.categories.delete',$post_category->id),'method'=>'delete'])}}
