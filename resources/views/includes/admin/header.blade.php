<!-- Navigation -->
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{route('dashboard')}}">Blog Admin</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{route('admin.posts')}}"><i class="fa fa-list fa-fw"></i>All Posts</a>
                                </li>
                                <li>
                                    <a href="{{route('admin.posts.show')}}"><i class="fa fa-plus fa-fw"></i>Add New</a>
                                </li>
                                <li>
                                    <a href="{{route('admin.categories')}}"><i class="fa fa-circle-o fa-fw"></i>Categories</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
