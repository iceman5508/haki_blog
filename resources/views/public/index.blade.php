    ...
    <div class="mx-0 sm:mx-6">
        ...
        <div class="bg-gray-200 w-full text-xl md:text-2xl text-gray-800 leading-normal rounded-t">
            ...
            <div class="flex h-full bg-white rounded overflow-hidden shadow-lg">
                <a href="{{route('post', ['post' => $data['featured']->slug])}}" class="flex flex-wrap no-underline hover:no-underline">
                    <div class="w-full md:w-2/3 rounded-t">
                        <img src="{{asset($data['featured']->featured_image->medium)}}" class="h-full w-full shadow">
                    </div>

                    <div class="w-full md:w-1/3 flex flex-col flex-grow flex-shrink">
                        <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                            <div class="w-full font-bold text-xl mb-2 mt-2 text-gray-900 px-6">{{$data['featured']->title}}</div>
...
{{--                    </div>--}}
                ...
                <div class="w-full md:w-2/3 p-6 flex flex-col flex-grow flex-shrink">
                    <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                        <a href="{{route('post', ['post' => $data['end_cards'][5]->slug])}}" class="flex flex-wrap no-underline hover:no-underline">
                            <img src="{{asset($data['end_cards'][5]->featured_image->medium)}}" class="h-full w-full rounded-t pb-6">
                            <div class="w-full font-bold text-xl text-gray-900 px-6 mt-2 mb-2">{{$data['end_cards'][5]->title}}</div>
                            <div class="text-gray-800 font-serif text-base px-6 mb-5">
...
{{--                    </div>--}}
                ...
                <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                    <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                        <a href="{{route('post', ['post' => $data['end_cards'][6]->slug])}}" class="flex flex-wrap no-underline hover:no-underline">
                            <img src="{{asset($data['end_cards'][6]->featured_image->medium)}}" class="h-full w-full rounded-t pb-6">
                            <div class="w-full font-bold text-xl text-gray-900 px-6 mt-2 mb-2">{{$data['end_cards'][6]->title}}</div>
                            <div class="text-gray-800 font-serif text-base px-6 mb-5">
